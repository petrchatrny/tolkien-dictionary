...
fun PrefsListItem(
    ...
    AnyLine.CustomListItem(
        modifier = modifier, minimalHeight, icon, styledSecondaryText, styledTrailing, styledText
    )
}
    ...
    fun CustomListItem(
        ...
        Row(
            modifier
                ...
                .padding(
                    start = ContentPadding, end = ContentPadding, top = when {
...
private fun applyTextStyle(
    textStyle: TextStyle, textColor: Color, contentAlpha: Float, content: @Composable (() -> Unit)?
): @Composable (() -> Unit)? {
